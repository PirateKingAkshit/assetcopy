            ...
            {dropdownLoading ? (
              ...
              <form onSubmit={handleSubmit(onSubmit)} autoComplete='off' className='flex flex-col gap-5'>
                ...
                <Controller
                  ...
                  control={control}
                  render={({ field }) => (
                    <FormControl fullWidth error={Boolean(errors.reportedTo)}>
                      <InputLabel id='reported-to-label'>Reported To</InputLabel>
                      <Select
                        {...field}
                        labelId='reported-to-label'
                        id='reported-to-select'
                        label='Reported To'
                        value={field.value || ''}
                      >
                      ...
                      {errors.reportedTo && <FormHelperText>{errors.reportedTo.message}</FormHelperText>}
                    </FormControl>
                  )}
                />
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <FormControl fullWidth error={Boolean(errors.roleId)}>
                      ...
                      <Select {...field} labelId='role-label' id='role-select' label='Role' required>
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <FormControl fullWidth error={Boolean(errors.departmentId)}>
                      ...
                      <Select {...field} labelId='department-label' id='department-select' label='Department' required>
                        <MenuItem value='' disabled>
                          Select Department
                        </MenuItem>
