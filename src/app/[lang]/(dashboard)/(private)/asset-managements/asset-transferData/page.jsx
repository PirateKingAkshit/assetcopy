...
import DiscardListTable from '@/components/discardAsset/disCardList'
import TransferListTable from '@/components/assetTransfer/transferList'
import TransferAsset from '@/components/assetTransfer/assettransfer'
...
const AssetList = async () => {
  ...
  return (
    <Grid container spacing={6}>
      ...
      <Grid size={{ xs: 12 }}>
        <TransferAsset productData={data?.products} />
      </Grid>
    </Grid>
  )
}
