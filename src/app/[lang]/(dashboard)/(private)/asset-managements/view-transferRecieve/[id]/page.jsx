...
import ViewApprovalTransfer from '@/components/transfer-approval/viewApprovalTransfer/viewApprovalTransfer'
import TransferRecieve from '@/components/transferRecieve/transferRecieve'
import ViewRecieveTransfer from '@/components/transferRecieve/viewTransferRecieve'
...
const TransferapprovalView = async () => {
  // Vars
  ...
  return (
    <Grid container spacing={6}>
      ...
      <Grid size={{ xs: 12 }}>
        <ViewRecieveTransfer productData={data?.products} />
      </Grid>
    </Grid>
  )
}
