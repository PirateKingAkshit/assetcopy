...
import UserListTable from '@/components/user-master/UserListTable'
import ClientUserListTable from '@/components/clientMaster/clientListTable'
...
const ClientMaster = async () => {
  ...
  return (
    <Grid container spacing={6}>
      ...
      <Grid size={{ xs: 12 }}>
        <ClientUserListTable productData={data?.products} />
      </Grid>
    </Grid>
  )
}
