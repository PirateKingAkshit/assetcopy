...
import StatusListTable from '@/components/asset-status/StatusListTable'
import MenuListTable from '@/components/menu-master/menuListTable'
import WDVListTable from '@/components/depreciationRate/depreciationlisttable'
...
const WDV = async () => {
  ...
  return (
    <Grid container spacing={6}>
      ...
      <Grid size={{ xs: 12 }}>
        <WDVListTable productData={data?.products} />
      </Grid>
    </Grid>
  )
}
