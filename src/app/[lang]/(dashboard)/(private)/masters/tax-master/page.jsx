...
import TaxListTable from '@/components/tax-master/TaxListTable'
...
const TaxProductList = async () => {
  ...
  return (
    <Grid container spacing={6}>
      ...
      <Grid size={{ xs: 12 }}>
        <TaxListTable productData={data?.products} />
      </Grid>
    </Grid>
  )
}

export default TaxProductList
