...
import TicketListTable from '@/components/tickets/ticketList'
import TicketSummaryPage from '@/components/tickets/ticket-summary/ticketSummary'
...
const TicketSummary = async () => {
  ...
  return (
   ...
   <Grid container spacing={6}>
      ...
      <Grid size={{ xs: 12 }}>
        <TicketSummaryPage productData={data?.products} />
      </Grid>
    </Grid>
  )
}
