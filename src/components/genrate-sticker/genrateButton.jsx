...
const GenrateButton = ({ onFilterApply, setData, productData, selectedRows, appliedFilters }) => {
  ...
  //   router.push(`/${router.query?.lang || 'en'}/asset-managements/genrate-stickerdata?ids=${selectedIds}`)
  // }
  ...
  const handleGenerateSticker = async () => {
    ...
    try {
      ...
      console.log('Generating stickers for IDs:', selectedIds)
      const response = await axiosInstance.post('/sticker', { asset: selectedIds })

      console.log('Sticker POST Response:', response.data)
      ...
      console.error('Error generating stickers:', err.response?.data || err.message)
      toast.error(`Error generating stickers: ${err.response?.data?.message || err.message}`)
    }
  }
