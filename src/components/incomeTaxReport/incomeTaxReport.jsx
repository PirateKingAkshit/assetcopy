...
const IncomeTaxreports = () => {
  ...
  const clientMethod = userData?.clientMethod;
  const financialYear = userData?.financialYear;
  ...
  const staticColumnDefs = useMemo(
    () => [
      { headerName: 'Asset Code', field: 'asset_code', sortable: true, filter: 'agTextColumnFilter'  , cellStyle: {
          display: 'flex',
          alignItems: 'center',
          padding: '0 10px',
          fontSize: '0.875rem',
      ...
      { headerName: 'Asset Name', field: 'asset_name', sortable: true, filter: 'agTextColumnFilter' , cellStyle: {
          display: 'flex',
          alignItems: 'center',
          padding: '0 10px',
          fontSize: '0.875rem',
      ...
      { headerName: 'Category', field: 'category',  cellStyle: {
          display: 'flex',
          alignItems: 'center',
          padding: '0 10px',
          fontSize: '0.875rem',
      ...
      { headerName: 'Location', field: 'location' ,  cellStyle: {
          display: 'flex',
          alignItems: 'center',
          padding: '0 10px',
          fontSize: '0.875rem',
      ...
      { headerName: 'Capitalization Date', field: 'capitalization_date',  cellStyle: {
          display: 'flex',
          alignItems: 'center',
          padding: '0 10px',
          fontSize: '0.875rem',
      ...
      { headerName: 'Lifetime (Months)', field: 'lifetime_months',  cellStyle: {
          display: 'flex',
          alignItems: 'center',
          padding: '0 10px',
          fontSize: '0.875rem',
      ...
      { headerName: 'Capitalization Amount', field: 'capitalization_amount',  cellStyle: {
          display: 'flex',
          alignItems: 'center',
          padding: '0 10px',
          fontSize: '0.875rem',
      ...
      { headerName: 'Scrap Value', field: 'scrap_value',  cellStyle: {
          display: 'flex',
          alignItems: 'center',
          padding: '0 10px',
          fontSize: '0.875rem',
      ...
      { headerName: 'Rate', field: 'rate',  cellStyle: {
          display: 'flex',
          alignItems: 'center',
          padding: '0 10px',
          fontSize: '0.875rem',
      ...
      { headerName: 'Shift', field: 'shift',  cellStyle: {
          display: 'flex',
          alignItems: 'center',
          padding: '0 10px',
          fontSize: '0.875rem',
      ...
      { headerName: 'Gross Value', field: 'gross_value',  cellStyle: {
          display: 'flex',
          alignItems: 'center',
          padding: '0 10px',
          fontSize: '0.875rem',
      ...
      { headerName: 'Opening Accumulated Depreciation', field: 'opening_accumulated_depreciation' ,  cellStyle: {
          display: 'flex',
          alignItems: 'center',
          padding: '0 10px',
          fontSize: '0.875rem',
      ...
      { headerName: 'Opening Net Balance', field: 'opening_net_balance' ,  cellStyle: {
          display: 'flex',
          alignItems: 'center',
          padding: '0 10px',
          fontSize: '0.875rem',
      ...
      { headerName: 'No. of Days', field: 'no_of_days',  cellStyle: {
          display: 'flex',
          alignItems: 'center',
          padding: '0 10px',
          fontSize: '0.875rem',
      ...
      { headerName: 'Depreciation', field: 'depreciation' ,  cellStyle: {
          display: 'flex',
          alignItems: 'center',
          padding: '0 10px',
          fontSize: '0.875rem',
      ...
      { headerName: 'Closing Accumulated Depreciation', field: 'closing_accumulated_depreciation' ,  cellStyle: {
          display: 'flex',
          alignItems: 'center',
          padding: '0 10px',
          fontSize: '0.875rem',
      ...
      { headerName: 'Closing Net Balance', field: 'closing_net_balance',  cellStyle: {
          display: 'flex',
          alignItems: 'center',
          padding: '0 10px',
          fontSize: '0.875rem',
  ...
  const generateReport = async () => {
    try {
      ...
      const response = await axiosInstance.post('/depriceationIncomeTaxReportRoute', {
...
const handleExport = async () => {
  try {
    ...
    const payload = {
      reporting_period_start_date: filters.startDate || null,
      reporting_period_end_date: filters.endDate || null,
      category: filters.category,
      location: filters.location
    };

    const response = await axiosInstance.post('depriceationReportRoute/download', payload, {
    ...
    const fileName = `Depreciation_Income_Tax_Report_${dayjs().format('YYYYMMDD_HHmmss')}.xlsx`;
  ...
  return (
    <Card className='flex flex-col'>
      <CardHeader title='IncomeTax Report Table' />
      {error && (
      ...
      <div className='flex flex-col p-5 gap-4'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4'>
          ...
          <FormControl fullWidth size='small' disabled>
            ...
            <Select value={clientMethod} label='Depreciation Method'>
              <MenuItem value={clientMethod || ''}>
                {clientMethod || 'N/A'}
              </MenuItem>
            </Select>
          </FormControl>
          ...
          <FormControl fullWidth size='small' disabled>
            ...
            <Select value={financialYear} label='Financial start month'>
              <MenuItem value={financialYear}>
                {financialYear}
              </MenuItem>
            </Select>
          </FormControl>
        ...
        <div className='flex gap-4 mt-4 justify-between items-center'>
          ...
          <div className='flex gap-2'>
            <Button type='submit' variant='contained' color='primary' disabled={loading} onClick={() => { generateReport() }}>
