...
const TaxFilter = ({ setData, productData }) => {
  // States
  ...
  const handleApplyFilter = () => {
    ...
    const filteredData = productData?.filter(product => {
      if (tempFilters.tax && product.tax !== tempFilters.tax) return false
  ...
  useEffect(() => {
    const filteredData = productData?.filter(product => {
      if (filters.tax && product.tax !== filters.tax) return false
