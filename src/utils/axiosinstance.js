...
import { toast } from 'react-toastify'
 ...
 const Baseurl = process.env.NEXT_PUBLIC_API_BASE_URL || 'https://assetsigma.com/backend/api';
    // const Baseurl = process.env.NEXT_PUBLIC_API_BASE_URL || 'http://192.168.1.5:5000/api/'
